...
class DriverOrderFailed extends StatefulWidget {
  const DriverOrderFailed({Key? key}) : super(key: key);

  @override
  _DriverOrderFailedState createState() => _DriverOrderFailedState();
}

class _DriverOrderFailedState extends State<DriverOrderFailed> {
  // Dimension
  late double width;
  late double height;
